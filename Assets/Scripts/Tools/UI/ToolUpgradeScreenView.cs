...
namespace Tools.UI
{
    ...
    /// </summary>
    public sealed class ToolUpgradeScreenView : MonoBehaviour
    {
        [Header("Tool")]
        ...
        [Header("Slots")]
        [SerializeField] private List<ToolSlot> slotButtons = new List<ToolSlot>(5);

        [Header("Selected Part")]
        [SerializeField] private TMP_Text selectedSlotText;
        [SerializeField] private Image selectedPartIconImage;
        [SerializeField] private TMP_Text selectedPartNameText;
        [SerializeField] private TMP_Text selectedPartLevelText;
        [SerializeField] private TMP_Text selectedPartStatusText;
