...
namespace IdleScaper.Scripts
{
    ...
    public static class Logger
    {
        ...
        {
            if (!EnableLogs || !EnableDebugLogs || !DebugMode) return;
        ...
        public static void LogSuccess(
            ...
            [CallerFilePath] string callerFilePath = "")
        {
            if (!EnableLogs || !EnableSuccessLogs || !DebugMode) return;
        ...
        public static void LogListener(
            ...
            [CallerFilePath] string callerFilePath = "")
        {
            if (!EnableLogs || !EnableListenerLogs || !DebugMode) return;
        ...
        public static void LogInit(
            ...
            [CallerFilePath] string callerFilePath = "")
        {
            if (!EnableLogs || !EnableInitializationLogs || !DebugMode) return;
        ...
        public static void LogConnection(
            ...
            [CallerFilePath] string callerFilePath = "")
        {
            if (!EnableLogs || !EnableConnectionLogs || !DebugMode) return;
        ...
        {
            if (!EnableLogs || !EnableWarningLogs || !DebugMode) return;
        ...
        public static void LogValue(
            ...
            [CallerFilePath] string callerFilePath = "")
        {
            if (!EnableLogs || !EnableValueLogs || !DebugMode) return;
